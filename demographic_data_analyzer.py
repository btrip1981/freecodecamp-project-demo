...
def calculate_demographic_data(print_data=True):
    ...
    rcc = df[df['salary'] == '>50K'].groupby('native-country').size() / df.groupby('native-country').size()
    highest_earning_country = rcc.idxmax()
    highest_earning_country_percentage = round(rcc.max()*100,1)
